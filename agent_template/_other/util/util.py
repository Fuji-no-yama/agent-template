...
def get_logger(
    ...
    now_jst: datetime = datetime.now(timezone(timedelta(hours=9)))
    time_stamp: str = now_jst.strftime("%Y%m%d_%H%M_%S")
    ...
    log_file_path: Path = log_dir_path / f"{file_prefix}_{time_stamp}.log"
